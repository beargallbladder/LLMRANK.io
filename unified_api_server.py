"""
Unified LLMRank.io API Server
Single, clear endpoint with access to ALL domains from your crawling blitz
"""
...
async def search_domains(
    ...
    matching_domains = [
        d for d in domains 
        if q.lower() in d['domain'].lower()
    ][:limit]
    
    return {
        "query": q,
        "total_matches": len(matching_domains),
